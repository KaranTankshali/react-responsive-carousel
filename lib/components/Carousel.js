...
var Carousel = function (_Component) {
    ...
    function Carousel(props) {
        ...
        _this.handleOnChange = function (index, item, isAutoSlide) {
            if (_react.Children.count(_this.props.children) <= 1) {
                return;
            }

            _this.props.onChange(index, item, isAutoSlide);
        };
        ...
        _this.decrement = function (positions, isAuto) {
            _this.moveTo(_this.state.selectedItem - (typeof positions === 'Number' ? positions : 1), isAuto);
        };

        _this.increment = function (positions, isAuto) {
            _this.moveTo(_this.state.selectedItem + (typeof positions === 'Number' ? positions : 1), isAuto);
        };

        _this.moveTo = function (position, isAuto) {
        ...
        _this.selectItem = function (state, isAutoSlide) {
            _this.setState(state);
            _this.handleOnChange(state.selectedItem, _react.Children.toArray(_this.props.children)[state.selectedItem], isAutoSlide);
        };
    ...
    _createClass(Carousel, [{
        ...
        value: function renderControls() {
            ...
            return _react2.default.createElement(
                ...
                _react.Children.map(this.props.children, function (item, index) {
                    return _react2.default.createElement('li', { className: _cssClasses2.default.DOT(index === _this4.state.selectedItem), onClick: _this4.changeItem,
        ...
        value: function renderThumbs() {
            ...
            return _react2.default.createElement(
                _Thumbs2.default,
                { ref: this.setThumbsRef, onSelectItem: this.handleClickThumb, selectedItem: this.state.selectedItem,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: _cssClasses2.default.WRAPPER(true, this.props.axis), style: containerStyles,
